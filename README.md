<p align="center">
    ...
    <h1 align="center">Yii 2 Basic Project Template With Init And Boostrap 4 CSS</h1>
    <br>
</p>
...
* Init your app
    ...
    ./init
    ~~~
* Edit your database information on config/db.php
* Run migration
    ~~~
    php yii migrate
    ~~~

Now you should be able to access the application through the following URL, assuming `yii2-with-init` is the directory
